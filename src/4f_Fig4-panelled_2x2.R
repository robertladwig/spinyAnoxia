...
par(mar = c(.5,1.5,.25,0), oma = c(1,.75,0,0))
...
par(fig = c(0,.42,0.5,1))
bar.spots <- barplot(ice.av, col = col.key$color, border = NA, las = 2, names.arg = rep("",ncol(ice.av)), axes = F)
box()
axis(side = 2, line = 0, las = 2, cex.axis = .7,tck = -.05, labels = F, at = 0:5, lwd = 0, lwd.ticks = 1)
axis(side = 2, lwd = 0, line = -.5, las = 2, cex.axis = .7, at = 0:5)
...
box()
axis(side = 2, line = 0, las = 2, cex.axis = .7,tck = -.05, labels = F, at = 0:6, lwd = 0, lwd.ticks = 1)
axis(side = 2, lwd = 0, line = -.5, las = 2, cex.axis = .7, at = 0:6)
...
index.labels <- seq.int(from = 1, to = length(colnames(fall.av)), by = 2)
text(x = bar.spots[index.labels], y = -.2, labels = colnames(fall.av)[index.labels], xpd = NA, srt = 90, adj = 1, cex = .7)
...
box()
axis(side = 2, line = 0, las = 2, cex.axis = .7,tck = -.05, labels = F, at = 0:7, lwd = 0, lwd.ticks = 1)
axis(side = 2, lwd = 0, line = -.5, las = 2, cex.axis = .7, at = 0:7)
...
box()
axis(side = 2, line = 0, las = 2, cex.axis = .7,tck = -.05, labels = F, at = seq.int(0,14,2), lwd = 0, lwd.ticks = 1)
axis(side = 2, lwd = 0, line = -.5, las = 2, cex.axis = .7)
...
index.labels <- seq.int(from = 1, to = length(colnames(fall.av)), by = 2)
text(x = bar.spots[index.labels], y = -.5, labels = colnames(fall.av)[index.labels], xpd = NA, srt = 90, adj = 1, cex = .7)
...
plot(1:10,1:10, type = "n", ann = F, axes = F)
mtext(text = "Biomass (mg/L)", side = 2, line = -.25, outer = T)
